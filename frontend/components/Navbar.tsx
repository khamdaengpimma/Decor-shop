    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <nav className="hidden md:flex items-center gap-8 text-sm font-semibold text-gray-600">
              ...
              {isLoggedIn && (
                <Link href="/orders" className="hover:text-amber-500 transition-colors">Orders</Link>
              )}
            </nav>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-t border-gray-200 flex md:hidden pb-safe">
        {[
          ...
          { label: "Sale",    icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z", href: "/sale" },
          ...(isLoggedIn ? [{ label: "Orders", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2", href: "/orders" }] : []),
          ...
          isLoggedIn
            ...
            : { label: "Login", icon: "M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a2 2 0 01-2 2H6a2 2 0 01-2-2V7a2 2 0 012-2h5a2 2 0 012 2v1", href: "/login" },
        ].map(({ label, icon, href, onClick }: any) => (
          <Link
            key={label}
            href={href}
            onClick={onClick}
            className={`flex-1 flex flex-col items-center justify-center py-2.5 gap-1 transition-colors ${label === 'Sale' ? 'text-rose-500 hover:text-rose-600' : 'text-gray-500 hover:text-amber-500'}`}
          >
